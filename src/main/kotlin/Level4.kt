...
//
//fun calcSequence(spaceStation: Int, timeLimit: Int): String {
...
//    }
//
//    return sequence.map { it * sign }.joinToString(" ")
//}
//
//fun solve4(level: Int, stage: String) {
...
//        val (spaceStation, timeLimit) = line.split(" ")
//        val (spaceX, spaceY) = spaceStation.split(",").map { it.toInt() }
//
//        var sequenceX = calcSequence(spaceX, timeLimit.toInt())
//        var sequenceY = calcSequence(spaceY, timeLimit.toInt())
//
//        if (sequenceX == "0 0") {
//            sequenceX = "0"
//        }
